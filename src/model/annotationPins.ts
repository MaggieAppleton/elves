...
const PIN_TOKENS: Record<CommentType | 'freeform', AnnotationPin> = {
  'needs-evidence': { icon: 'quote', tone: 'needs-evidence', label: 'Needs evidence' },
  'weak-argument': { icon: 'warning', tone: 'weak-argument', label: 'Weak argument' },
  ...
  structure: { icon: 'branch', tone: 'structure', label: 'Structure' },
  freeform: { icon: 'message', tone: 'freeform', label: 'Comment' },
}
