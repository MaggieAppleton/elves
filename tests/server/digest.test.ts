    ...
    document: {
      store: {
        ...
        'shape:a': {
          ...
          props: { w: 240, h: 120, kind: 'prose', sourceKind: null, origin: null, text: 'note', comments: [], mergedInto: null, assetId: null, reference: null, summary: null, summaryOfHash: null, summaryBy: null, summaryAt: null },
        },
        'shape:b': {
          id: 'shape:b', typeName: 'shape', type: 'card', x: 30, y: 10, parentId: 'shape:g',
          props: { w: 240, h: 120, kind: 'source', sourceKind: 'reference', origin: 'reference', text: '', comments: [], mergedInto: null, assetId: null, reference: null, summary: null, summaryOfHash: null, summaryBy: null, summaryAt: null },
        },
        'shape:c': {
          id: 'shape:c', typeName: 'shape', type: 'card', x: 500, y: 500, parentId: 'page:p',
          props: { w: 240, h: 120, kind: 'prose', sourceKind: null, origin: null, text: 'alone', comments: [], mergedInto: null, assetId: null, reference: null, summary: null, summaryOfHash: null, summaryBy: null, summaryAt: null },
        },
      },
    },
    session: null,
